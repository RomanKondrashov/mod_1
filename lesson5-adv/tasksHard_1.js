'use strict';
    ...
    if (salary <= level1){
        console.log(`Первый уровень налога (13%): ${salary*level0Tax}`);
    }

    if (salary > level1 && salary <= level2){
        console.log(`Второй уровень налога (20%): ${salary*level1Tax}`);
    }

    if (salary > level2){
        console.log(`Третий уровень налога (30%): ${salary*level2Tax}`);
    }
